                        ...
                        <div className="row">
                            <div className="col-md-9">
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea onChange={(e) => setDescription(e.target.value)} value={description} name="description" rows={15} className="form-control" placeholder="Nhập mô tả" defaultValue={""} />
                                </div>
                            </div>
